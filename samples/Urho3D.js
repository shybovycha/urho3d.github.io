...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 11362890;
    var PACKAGE_UUID = '22e87865-1db8-4f9c-a099-f83505f51f1d';
...
function assert(check, msg) {
  if (!check) throw msg + new Error().stack;
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 122070, 0, 0).open('GET', '/CoreData.pak');
    new DataRequest(122070, 11362890, 0, 0).open('GET', '/Data.pak');
