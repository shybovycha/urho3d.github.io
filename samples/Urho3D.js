...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 11376014;
    var PACKAGE_UUID = '7d6a7887-0a18-47a5-94c7-c24e2ad6b2cd';
...
function assert(check, msg) {
  if (!check) throw msg + new Error().stack;
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 121554, 0, 0).open('GET', '/CoreData.pak');
    new DataRequest(121554, 11376014, 0, 0).open('GET', '/Data.pak');
